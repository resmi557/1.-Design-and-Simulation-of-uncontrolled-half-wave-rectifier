...
5.	Construct the circuit by joining them together.
...
10.	Double click on SCOPE and then click on parameter icon.
11.	Make the number of axes as required.
12.	Before running the simulation, we have to configure the parameters. Go to Simulation ⇒ Configuration parameters.
13.	Select the ode23tb (Stiff/TR-BDF2) or ode15s (Stiff/NDS) or any suitable solver.
14.	Start the simulation by either clicking on Start Simulation icon or
